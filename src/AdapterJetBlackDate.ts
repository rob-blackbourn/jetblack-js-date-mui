import {
  ...
  export class AdapterJetBlackDate implements MuiPickersAdapter<Date> {
    ...
    constructor({ locale, formats, tz }: AdapterJetBlackDateOptions = {}) {
    ...
    format = (value: Date, formatKey: keyof AdapterFormats<string>): string =>
